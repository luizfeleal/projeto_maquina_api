...
class ApiExtratoMaquinaTest extends TestCase
{
    ...
    public function post_access_groups_with_empty_body_and_error_message()
    {
        ...
        $response = $this->post('/api/extratoMaquina'); // Use $this->post para fazer a solicitação
