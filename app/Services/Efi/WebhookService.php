...
class WebhookService
{
    ...
    public static function criarEndpoint(string $token, string $chave, string $caminhoCertificado)
    {
        ...
        CURLOPT_URL => $homolog ? "https://pix-h.api.efipay.com.br/v2/webhook/".$chave : "https://pix.api.efipay.com.br/v2/webhook/" . $chave,
        ...
        CURLOPT_POSTFIELDS => '{"webhookUrl": "https://services.swiftpaysolucoes.com/api/webhook/efi/pix"}',
